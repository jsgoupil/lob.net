...
namespace Lob.Net.Tests
{
    public class UsVerificationsTests : BaseRequestTests
    {
        ...
        public async Task UsVerifications()
        {
            ...
            var result = await usVerifications.VerifyAsync(new UsVerificationRequest("1709 Broderick St", "San Francisco", state: "CA"));
        ...
        public async Task UsAutocompletions()
        {
            ...
            var usVerifications = serviceProvider.GetService<ILobUsVerifications>();
            var result = await usVerifications.AutocompleteAsync(new UsAutocompletionRequest
            {
                AddressPrefix = "5 su",
                City = "San Francisco",
                GeoIpSort = true,
        ...
        public async Task UsZipLookups()
        {
            ...
            var usVerifications = serviceProvider.GetService<ILobUsVerifications>();
            var result = await usVerifications.ZipLookupAsync("94133");
